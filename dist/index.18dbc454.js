...
document.getElementById("slideshowcontainer").addEventListener("click", function(event) {
    ...
    if (event.target.classList.contains("prev")) plusSlides(-1); // Gå ett steg bakåt
    // Kontrollera om det klickade elementet har klassen 'next'
    if (event.target.classList.contains("next")) plusSlides(1); // Gå ett steg framåt
});
let slideIndex = 1;
...
},{}]},["j2YDk","1SICI"], "1SICI", "parcelRequiree265")
